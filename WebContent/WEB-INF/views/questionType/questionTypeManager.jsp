...
<div class="clear"></div>
	<div class="wrap">
		<div class="margincenter">
	    	...
	    	<div style="width:20%;height:800px; border:1px solid #ccc; float: left;" class = "systemList">
	    	</div>
					...
					<div  class="so-popbox-cont">
						<form action="addQuestionType" method="post">
							...
							<p>
								...
								<select name="departmentId"  class ="selectQuestion">
	...
	$('.pagination').jqPagination({
	    ...
	    paged: function(page) {
			...
			window.location.href = "toQuestionType?systemIndex=${systemIndex}&pageIndex=" + page + "&pageSize=15";
		    }
	});
</script>
</body>